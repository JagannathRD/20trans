...
void getCricketDetails(boolean isThirdUmpire,int noOfPowerPlays,
String typeOfMatch){
	System.out.println("Thrid umpire "+ isThirdUmpire+ " No of power plays "+
 noOfPowerPlays+" Type of Match "+
 typeOfMatch);
}
